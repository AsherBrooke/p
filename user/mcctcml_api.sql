...
--
-- Host: localhost
-- Generation Time: 28 พ.ย. 2021 เมื่อ 04:17 PM
-- เวอร์ชันของเซิร์ฟเวอร์: 10.4.18-MariaDB
-- PHP Version: 7.4.16
...
INSERT INTO `free` (`id`, `token`) VALUES
(1, 'CTC-Panel_free');
...
INSERT INTO `users` (`id`, `username`, `password`, `group`,`token` ) VALUES
(1, 'admins', 'CTC@123', 'member', '');
